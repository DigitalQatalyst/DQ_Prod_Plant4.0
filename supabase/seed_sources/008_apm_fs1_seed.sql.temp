...
BEGIN
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ts := NOW() - (day_offset || ' days')::INTERVAL - (hour_offset || ' hours')::INTERVAL;
      ...
      VALUES (ts, tx1_id, top_oil_temp_id, 70 + (RANDOM() * 20), '°C', 95 + (RANDOM() * 5));
      
      -- Winding hot spot: Normal
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, tx1_id, winding_hot_spot_id, 85 + (RANDOM() * 15), '°C', 95 + (RANDOM() * 5));
      
      -- Load current: Normal
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, tx1_id, load_current_id, 800 + (RANDOM() * 400), 'A', 98 + (RANDOM() * 2));
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    ...
    INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
    VALUES (ts, tx1_id, dga_h2_id, 80 + (RANDOM() * 40), 'ppm', 90 + (RANDOM() * 10));
    
    INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
    VALUES (ts, tx1_id, dga_ch4_id, 90 + (RANDOM() * 50), 'ppm', 90 + (RANDOM() * 10));
    
    INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
    VALUES (ts, tx1_id, dga_c2h2_id, 25 + (RANDOM() * 20), 'ppm', 90 + (RANDOM() * 10));
    
    INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
    VALUES (ts, tx1_id, moisture_ppm_id, 20 + (RANDOM() * 15), 'ppm', 90 + (RANDOM() * 10));
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, tx1_id, vibration_id, 4 + (RANDOM() * 3), 'mm/s', 95 + (RANDOM() * 5));
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      IF day_offset = 2 THEN
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, cb101_id, sf6_pressure_id, 4.3 + (RANDOM() * 0.3), 'bar', 95 + (RANDOM() * 5));
      ELSE
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, cb101_id, sf6_pressure_id, 5.5 + (RANDOM() * 0.5), 'bar', 95 + (RANDOM() * 5));
      END IF;
      
      -- SF6 density: Normal
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb101_id, sf6_density_id, 42 + (RANDOM() * 3), 'kg/m³', 95 + (RANDOM() * 5));
      
      -- Contact wear: Warning level
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb101_id, contact_wear_id, 65 + (RANDOM() * 10), '%', 90 + (RANDOM() * 10));
      
      -- Operation count: incrementing
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb101_id, operation_count_id, 1250 + day_offset, 'ops', 100);
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    ...
    INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
    VALUES (ts, cb101_id, trip_coil_current_id, 4.5 + (RANDOM() * 1.0), 'A', 95 + (RANDOM() * 5));
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb102_id, sf6_pressure_id, 5.8 + (RANDOM() * 0.4), 'bar', 95 + (RANDOM() * 5));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb102_id, sf6_density_id, 44 + (RANDOM() * 2), 'kg/m³', 95 + (RANDOM() * 5));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb102_id, contact_wear_id, 45 + (RANDOM() * 10), '%', 90 + (RANDOM() * 10));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, cb102_id, operation_count_id, 980 + day_offset, 'ops', 100);
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      IF hour_offset >= 12 AND hour_offset <= 18 THEN
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, line_n01_id, conductor_temp_id, 78 + (RANDOM() * 8), '°C', 95 + (RANDOM() * 5));
      ELSE
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, line_n01_id, conductor_temp_id, 55 + (RANDOM() * 15), '°C', 95 + (RANDOM() * 5));
      END IF;
      
      -- Current: High during peak hours
      IF hour_offset >= 12 AND hour_offset <= 18 THEN
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, line_n01_id, current_id, 1000 + (RANDOM() * 150), 'A', 98 + (RANDOM() * 2));
      ELSE
        INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
        VALUES (ts, line_n01_id, current_id, 600 + (RANDOM() * 200), 'A', 98 + (RANDOM() * 2));
      END IF;
      
      -- Wind speed: Normal
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, line_n01_id, wind_speed_id, 3 + (RANDOM() * 7), 'm/s', 90 + (RANDOM() * 10));
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, line_n02_id, conductor_temp_id, 50 + (RANDOM() * 15), '°C', 95 + (RANDOM() * 5));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, line_n02_id, current_id, 500 + (RANDOM() * 200), 'A', 98 + (RANDOM() * 2));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, line_n02_id, wind_speed_id, 2 + (RANDOM() * 5), 'm/s', 90 + (RANDOM() * 10));
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay1_id, trip_events_id, 0, 'events', 100);
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay1_id, self_test_status_id, 1, 'bool', 100);
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay1_id, comms_latency_id, 15 + (RANDOM() * 20), 'ms', 95 + (RANDOM() * 5));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay1_id, time_sync_offset_id, 2 + (RANDOM() * 5), 'ms', 95 + (RANDOM() * 5));
    END LOOP;
  END LOOP;
  ...
  FOR day_offset IN 0..6 LOOP
    FOR hour_offset IN 0..23 LOOP
      ...
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay2_id, trip_events_id, 0, 'events', 100);
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay2_id, self_test_status_id, 1, 'bool', 100);
      
      -- Comms latency: Warning level
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay2_id, comms_latency_id, 95 + (RANDOM() * 20), 'ms', 85 + (RANDOM() * 10));
      
      INSERT INTO telemetry_data (timestamp, asset_id, parameter_id, value, unit, quality_score)
      VALUES (ts, relay2_id, time_sync_offset_id, 3 + (RANDOM() * 4), 'ms', 95 + (RANDOM() * 5));
    END LOOP;
  END LOOP;
