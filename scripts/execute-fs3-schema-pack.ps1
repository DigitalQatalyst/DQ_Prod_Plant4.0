...
$schemaPackDir = ".kiro/specs/apm-transmission-full/schema_packs/apm_tx_fs3_performance_utilisation"
...
Write-Step "FS3 Schema Pack Execution Complete"

Write-Host ""
Write-Success "All steps completed successfully!"
Write-Host ""
Write-Host "Next Steps:" -ForegroundColor $InfoColor
Write-Host "  1. Implement FS3 API query hooks" -ForegroundColor Gray
Write-Host "  2. Enhance FS3 UI pages with real functionality" -ForegroundColor Gray
Write-Host "  3. Navigate to /monitor/performance-utilisation/* to test pages" -ForegroundColor Gray
Write-Host "  4. Proceed to FS2 Predictive Maintenance" -ForegroundColor Gray
Write-Host ""
